...
- The approved logo is Ember Lens with matched crescent C (15% wider). Follow `brand/README.md`; regenerate both platforms from `brand/ember-lens.svg` with `pnpm brand:generate`. Do not substitute historical concepts or stock flame icons.
